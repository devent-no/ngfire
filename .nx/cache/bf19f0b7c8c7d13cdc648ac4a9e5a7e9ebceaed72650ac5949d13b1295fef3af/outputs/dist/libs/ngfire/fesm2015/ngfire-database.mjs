...
const DATABASE = new InjectionToken('Database instance', {
    ...
    factory: () => {
        ...
        if (config.database) {
            return config.database(app, url !== null && url !== void 0 ? url : undefined);
        }
        else {
            return getDatabase(app, url !== null && url !== void 0 ? url : undefined);
        }
    },
});
...
function addMeta(doc, actionType) {
    var _a;
    const _meta = (_a = doc['_meta']) !== null && _a !== void 0 ? _a : {};
    if (actionType === 'add')
...
class FireList {
    ...
    getValue(query, params) {
        return __awaiter(this, arguments, void 0, function* () {
            ...
            const snap = yield this.getQuery(query, params);

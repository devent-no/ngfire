import { ReplaySubject, timer, of, Observable, from, combineLatest, queueScheduler, asyncScheduler } from 'rxjs';
...
function joinWith(queries, options = {}) {
    var _a, _b;
    const shouldAwait = (_a = options.shouldAwait) !== null && _a !== void 0 ? _a : true;
    const debounce = (_b = options.debounceTime) !== null && _b !== void 0 ? _b : 100;
